...
const DICT = {
	en: {
		...
		auraLedgerTitle: "Aura Feed",
		auraLedgerEmpty: "No aura changes for this game day yet.",
		auraLedgerCouldNotLoad: "Could not load aura ledger.",
		auraLedgerWave: "{from} waved {to}",
		auraLedgerMegSend: "{from} megged {to}",
		auraLedgerMegRecv: "{from} megged {to}",
		auraLedgerRegister: "{name} joined the list",
		auraLedgerUnregister: "{name} left the list",
		auraLedgerGuestBonus: "{name} brought guests",
		auraLedgerUnregisterPenalty: "{name} unregistered (penalty)",
		auraLedgerEmojiBonus: "{name} set emoji",
		auraLedgerWeekProxy: "{name} got weekly proxy",
	...
	es: {
		...
		auraLedgerTitle: "Libro de aura",
		auraLedgerEmpty: "Todavía no hay cambios de aura para este día.",
		auraLedgerCouldNotLoad: "No se pudo cargar el libro de aura.",
		auraLedgerWave: "{from} saludó a {to}",
		auraLedgerMegSend: "{from} hizo tunel a {to}",
		auraLedgerMegRecv: "{from} hizo tunel a {to}",
		auraLedgerRegister: "{name} se apuntó",
		auraLedgerUnregister: "{name} se salió de la lista",
		auraLedgerGuestBonus: "{name} trajo invitados",
		auraLedgerUnregisterPenalty: "{name} se salió (penalización)",
		auraLedgerEmojiBonus: "{name} puso emoji",
		auraLedgerWeekProxy: "{name} recibió proxy semanal",
