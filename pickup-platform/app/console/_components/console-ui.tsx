...
export const btnPrimary =
  'inline-flex items-center justify-center gap-1.5 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500 disabled:opacity-50'

export const btnSecondary =
  'inline-flex items-center justify-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-zinc-100 transition hover:bg-white/10 disabled:opacity-50'

export const btnOutline =
  'inline-flex items-center justify-center gap-1.5 rounded-lg border border-white/10 px-3 py-2 text-xs font-medium text-zinc-200 transition hover:border-white/20 hover:bg-white/5'
...
export function ConsoleHeader({
  ...
  return (
    <div>
      ...
      <div className={`flex items-start justify-between gap-4 ${backHref ? 'mt-5' : ''}`}>
...
export function ConsoleSection({
  ...
  return (
    <section
      className={`overflow-hidden rounded-xl border border-white/10 bg-zinc-900/50 ${className}`}
    >
      {title ? (
