...
export function HiddenBottomNav({ items, accent, basePath, slug }: Props) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 border-t border-zinc-800/80 bg-zinc-950/95 backdrop-blur-md">
      ...
      <footer className="mx-auto flex max-w-lg items-center justify-between gap-2 border-t border-white/10 px-5 py-1.5 pb-[max(0.25rem,env(safe-area-inset-bottom))] text-[10px] leading-none text-zinc-600">
