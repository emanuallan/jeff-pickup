...
export function OrgPublicSiteFooter({ slug }: { slug: string }) {
  return (
    <footer className="mt-16 flex items-center justify-between gap-4 border-t border-zinc-800/70 pt-6 text-xs text-zinc-600">
