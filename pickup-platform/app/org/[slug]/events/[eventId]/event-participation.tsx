...
import { FirstToRsvpCelebration } from './first-to-rsvp'
  ...
  return (
    <>
      ...
      <section className="mt-5 rounded-3xl border border-zinc-800 bg-zinc-900/50 p-5">
        ...
        {isFirstToRsvp ? <FirstToRsvpCelebration accent={accent} /> : null}
        <div className={isFirstToRsvp ? '' : 'mt-4'}>
