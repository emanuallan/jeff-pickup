-- Public org session feed: MVP results and self-reported goals/assists
...
grant execute on function public.get_org_session_feed(uuid, int) to anon, authenticated;
