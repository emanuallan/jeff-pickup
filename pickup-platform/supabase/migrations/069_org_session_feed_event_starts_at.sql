-- Include session start time on org session feed items so public surfaces
-- (e.g. ScrollingFeedUpdateBar) can show the event date, not the post time.
      ...
      from (
        ...
        from (
          select jsonb_build_object(
            ...
            'event_timezone', coalesce(e.timezone, 'UTC'),
