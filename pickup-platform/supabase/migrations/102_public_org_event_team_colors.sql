-- Expose session team count + shirt colors on the public org/event RPC.
-- Headcount polling uses this payload; without these fields the roster painted
-- SSR colors then wiped them on the first live refresh.
...
grant execute on function public.get_public_org_and_event(text, text)
