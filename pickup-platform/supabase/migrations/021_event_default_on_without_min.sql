-- Sessions default to on unless min_players is set (then tentative until threshold met).
...
-- Align existing upcoming sessions with the new default.
update public.events
set status = 'on'
